...
* 控件靠上对齐
	...
	![](/img/AutoLayout/top-i4.png) ![](/img/AutoLayout/top-i5.png) ![](/img/AutoLayout/top-i6.png)

* 控件靠下对齐

	设置方式:
	
	![](/img/AutoLayout/bottom.png)
...
4. [中级] 在UIScrollView顺序排列一些view并自动计算contentSize
	...
	![](/img/AutoLayout/head.png) ![](/img/AutoLayout/tail.png)
...
* Sizeclass的作用
	...
	![](/img/AutoLayout/2.png)
	![](/img/AutoLayout/3.png)
	![](/img/AutoLayout/4.png)
	![](/img/AutoLayout/5.png)
	![](/img/AutoLayout/6.png)
